...
The latest version (Tomcat 7.0.47, Slf4j 1.7.5, Logback 1.0.13) may be
downloaded from
...
* `logback-core-1.0.13.jar` to `$CATALINA_HOME/lib`
* `logback-access-1.0.13.jar` to `$CATALINA_HOME/lib`
